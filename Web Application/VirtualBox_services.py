...
class vboxBindingSOAP:
    ...
    # op: IVirtualBox_createLegacyMachine
    def IVirtualBox_createLegacyMachine(self, request):
        if isinstance(request, IVirtualBox_createLegacyMachineRequestMsg) is False:
            raise TypeError, "%s incorrect request type" % (request.__class__)
        kw = {}
        # no input wsaction
        self.binding.Send(None, None, request, soapaction="", **kw)
        # no output wsaction
        response = self.binding.Receive(IVirtualBox_createLegacyMachineResultMsg.typecode)
        return response
    ...
    def IVirtualBox_getMachine(self, request):
    ...
    # op: IVirtualBox_unregisterMachine
    def IVirtualBox_unregisterMachine(self, request):
        if isinstance(request, IVirtualBox_unregisterMachineRequestMsg) is False:
            raise TypeError, "%s incorrect request type" % (request.__class__)
        kw = {}
        # no input wsaction
        self.binding.Send(None, None, request, soapaction="", **kw)
        # no output wsaction
        response = self.binding.Receive(IVirtualBox_unregisterMachineResultMsg.typecode)
        return response
    ...
    # op: IVirtualBox_openHardDisk
    def IVirtualBox_openHardDisk(self, request):
        if isinstance(request, IVirtualBox_openHardDiskRequestMsg) is False:
            raise TypeError, "%s incorrect request type" % (request.__class__)
        kw = {}
        # no input wsaction
        self.binding.Send(None, None, request, soapaction="", **kw)
        # no output wsaction
        response = self.binding.Receive(IVirtualBox_openHardDiskResultMsg.typecode)
        return response

    # op: IVirtualBox_getHardDisk
    def IVirtualBox_getHardDisk(self, request):
        if isinstance(request, IVirtualBox_getHardDiskRequestMsg) is False:
            raise TypeError, "%s incorrect request type" % (request.__class__)
        kw = {}
        # no input wsaction
        self.binding.Send(None, None, request, soapaction="", **kw)
        # no output wsaction
        response = self.binding.Receive(IVirtualBox_getHardDiskResultMsg.typecode)
        return response

    # op: IVirtualBox_findHardDisk
    def IVirtualBox_findHardDisk(self, request):
        if isinstance(request, IVirtualBox_findHardDiskRequestMsg) is False:
            raise TypeError, "%s incorrect request type" % (request.__class__)
        kw = {}
        # no input wsaction
        self.binding.Send(None, None, request, soapaction="", **kw)
        # no output wsaction
        response = self.binding.Receive(IVirtualBox_findHardDiskResultMsg.typecode)
        return response

    # op: IVirtualBox_openDVDImage
    def IVirtualBox_openDVDImage(self, request):
        if isinstance(request, IVirtualBox_openDVDImageRequestMsg) is False:
            raise TypeError, "%s incorrect request type" % (request.__class__)
        kw = {}
        # no input wsaction
        self.binding.Send(None, None, request, soapaction="", **kw)
        # no output wsaction
        response = self.binding.Receive(IVirtualBox_openDVDImageResultMsg.typecode)
        return response

    # op: IVirtualBox_getDVDImage
    def IVirtualBox_getDVDImage(self, request):
        if isinstance(request, IVirtualBox_getDVDImageRequestMsg) is False:
            raise TypeError, "%s incorrect request type" % (request.__class__)
        kw = {}
        # no input wsaction
        self.binding.Send(None, None, request, soapaction="", **kw)
        # no output wsaction
        response = self.binding.Receive(IVirtualBox_getDVDImageResultMsg.typecode)
        return response

    # op: IVirtualBox_findDVDImage
    def IVirtualBox_findDVDImage(self, request):
        if isinstance(request, IVirtualBox_findDVDImageRequestMsg) is False:
            raise TypeError, "%s incorrect request type" % (request.__class__)
        kw = {}
        # no input wsaction
        self.binding.Send(None, None, request, soapaction="", **kw)
        # no output wsaction
        response = self.binding.Receive(IVirtualBox_findDVDImageResultMsg.typecode)
        return response

    # op: IVirtualBox_openFloppyImage
    def IVirtualBox_openFloppyImage(self, request):
        if isinstance(request, IVirtualBox_openFloppyImageRequestMsg) is False:
            raise TypeError, "%s incorrect request type" % (request.__class__)
        kw = {}
        # no input wsaction
        self.binding.Send(None, None, request, soapaction="", **kw)
        # no output wsaction
        response = self.binding.Receive(IVirtualBox_openFloppyImageResultMsg.typecode)
        return response

    # op: IVirtualBox_getFloppyImage
    def IVirtualBox_getFloppyImage(self, request):
        if isinstance(request, IVirtualBox_getFloppyImageRequestMsg) is False:
            raise TypeError, "%s incorrect request type" % (request.__class__)
        kw = {}
        # no input wsaction
        self.binding.Send(None, None, request, soapaction="", **kw)
        # no output wsaction
        response = self.binding.Receive(IVirtualBox_getFloppyImageResultMsg.typecode)
        return response

    # op: IVirtualBox_findFloppyImage
    def IVirtualBox_findFloppyImage(self, request):
        if isinstance(request, IVirtualBox_findFloppyImageRequestMsg) is False:
            raise TypeError, "%s incorrect request type" % (request.__class__)
        kw = {}
        # no input wsaction
        self.binding.Send(None, None, request, soapaction="", **kw)
        # no output wsaction
        response = self.binding.Receive(IVirtualBox_findFloppyImageResultMsg.typecode)
        return response
    ...
    # op: IVirtualBox_openSession
    def IVirtualBox_openSession(self, request):
        if isinstance(request, IVirtualBox_openSessionRequestMsg) is False:
            raise TypeError, "%s incorrect request type" % (request.__class__)
        kw = {}
        # no input wsaction
        self.binding.Send(None, None, request, soapaction="", **kw)
    ...
    # op: IVirtualBox_openRemoteSession
    def IVirtualBox_openRemoteSession(self, request):
        if isinstance(request, IVirtualBox_openRemoteSessionRequestMsg) is False:
            raise TypeError, "%s incorrect request type" % (request.__class__)
        kw = {}
        # no input wsaction
        self.binding.Send(None, None, request, soapaction="", **kw)
        # no output wsaction
        response = self.binding.Receive(IVirtualBox_openRemoteSessionResultMsg.typecode)
        return response

    # op: IVirtualBox_openExistingSession
    def IVirtualBox_openExistingSession(self, request):
        if isinstance(request, IVirtualBox_openExistingSessionRequestMsg) is False:
            raise TypeError, "%s incorrect request type" % (request.__class__)
        kw = {}
        # no input wsaction
        self.binding.Send(None, None, request, soapaction="", **kw)
        # no output wsaction
        response = self.binding.Receive(IVirtualBox_openExistingSessionResultMsg.typecode)
        return response

    # op: IVirtualBox_waitForPropertyChange
    def IVirtualBox_waitForPropertyChange(self, request):
    ...
    def IMachine_getVRDPServer(self, request):
    ...
    # op: IMachine_getIoBandwidthMax
    def IMachine_getIoBandwidthMax(self, request):
        if isinstance(request, IMachine_getIoBandwidthMaxRequestMsg) is False:
            raise TypeError, "%s incorrect request type" % (request.__class__)
        kw = {}
        # no input wsaction
        self.binding.Send(None, None, request, soapaction="", **kw)
        # no output wsaction
        response = self.binding.Receive(IMachine_getIoBandwidthMaxResultMsg.typecode)
        return response

    # op: IMachine_setIoBandwidthMax
    def IMachine_setIoBandwidthMax(self, request):
        if isinstance(request, IMachine_setIoBandwidthMaxRequestMsg) is False:
            raise TypeError, "%s incorrect request type" % (request.__class__)
        kw = {}
        # no input wsaction
        self.binding.Send(None, None, request, soapaction="", **kw)
        # no output wsaction
        response = self.binding.Receive(IMachine_setIoBandwidthMaxResultMsg.typecode)
        return response
    ...
    # op: IMachine_deleteSettings
    def IMachine_deleteSettings(self, request):
        if isinstance(request, IMachine_deleteSettingsRequestMsg) is False:
            raise TypeError, "%s incorrect request type" % (request.__class__)
        kw = {}
        # no input wsaction
        self.binding.Send(None, None, request, soapaction="", **kw)
        # no output wsaction
        response = self.binding.Receive(IMachine_deleteSettingsResultMsg.typecode)
        return response
    ...
    def IMachine_getSnapshot(self, request):
    ...
    def IMachine_setCurrentSnapshot(self, request):
    ...
    def IConsole_getRemoteDisplayInfo(self, request):
    ...
    # op: IConsole_forgetSavedState
    def IConsole_forgetSavedState(self, request):
        if isinstance(request, IConsole_forgetSavedStateRequestMsg) is False:
            raise TypeError, "%s incorrect request type" % (request.__class__)
        kw = {}
        # no input wsaction
        self.binding.Send(None, None, request, soapaction="", **kw)
        # no output wsaction
        response = self.binding.Receive(IConsole_forgetSavedStateResultMsg.typecode)
        return response
    ...
    # op: ISystemProperties_getMaxVDISize
    def ISystemProperties_getMaxVDISize(self, request):
        if isinstance(request, ISystemProperties_getMaxVDISizeRequestMsg) is False:
            raise TypeError, "%s incorrect request type" % (request.__class__)
        kw = {}
        # no input wsaction
        self.binding.Send(None, None, request, soapaction="", **kw)
        # no output wsaction
        response = self.binding.Receive(ISystemProperties_getMaxVDISizeResultMsg.typecode)
        return response
    ...
    def ISystemProperties_getDefaultHardDiskFolder(self, request):
    ...
    def ISystemProperties_setDefaultHardDiskFolder(self, request):
    ...
    def ISystemProperties_getRemoteDisplayAuthLibrary(self, request):
    ...
    def ISystemProperties_setRemoteDisplayAuthLibrary(self, request):
    ...
    # op: IGuest_getAdditionsActive
    def IGuest_getAdditionsActive(self, request):
        if isinstance(request, IGuest_getAdditionsActiveRequestMsg) is False:
            raise TypeError, "%s incorrect request type" % (request.__class__)
        kw = {}
        # no input wsaction
        self.binding.Send(None, None, request, soapaction="", **kw)
        # no output wsaction
        response = self.binding.Receive(IGuest_getAdditionsActiveResultMsg.typecode)
        return response
    ...
    # op: IGuest_getPageFusionEnabled
    def IGuest_getPageFusionEnabled(self, request):
        if isinstance(request, IGuest_getPageFusionEnabledRequestMsg) is False:
            raise TypeError, "%s incorrect request type" % (request.__class__)
        kw = {}
        # no input wsaction
        self.binding.Send(None, None, request, soapaction="", **kw)
        # no output wsaction
        response = self.binding.Receive(IGuest_getPageFusionEnabledResultMsg.typecode)
        return response

    # op: IGuest_setPageFusionEnabled
    def IGuest_setPageFusionEnabled(self, request):
        if isinstance(request, IGuest_setPageFusionEnabledRequestMsg) is False:
            raise TypeError, "%s incorrect request type" % (request.__class__)
        kw = {}
        # no input wsaction
        self.binding.Send(None, None, request, soapaction="", **kw)
        # no output wsaction
        response = self.binding.Receive(IGuest_setPageFusionEnabledResultMsg.typecode)
        return response
    ...
    def IVRDPServer_getEnabled(self, request):
    ...
    def IVRDPServer_setEnabled(self, request):
    ...
    def IVRDPServer_getPorts(self, request):
    ...
    def IVRDPServer_setPorts(self, request):
    ...
    def IVRDPServer_getNetAddress(self, request):
    ...
    def IVRDPServer_setNetAddress(self, request):
    ...
    def IVRDPServer_getAuthType(self, request):
    ...
    def IVRDPServer_setAuthType(self, request):
    ...
    def IVRDPServer_getAuthTimeout(self, request):
    ...
    def IVRDPServer_setAuthTimeout(self, request):
    ...
    def IVRDPServer_getAllowMultiConnection(self, request):
    ...
    def IVRDPServer_setAllowMultiConnection(self, request):
    ...
    def IVRDPServer_getReuseSingleConnection(self, request):
    ...
    def IVRDPServer_setReuseSingleConnection(self, request):
    ...
    def IVRDPServer_getVideoChannel(self, request):
    ...
    def IVRDPServer_setVideoChannel(self, request):
    ...
    def IVRDPServer_getVideoChannelQuality(self, request):
    ...
    def IVRDPServer_setVideoChannelQuality(self, request):
    ...
    # op: ISession_close
    def ISession_close(self, request):
        if isinstance(request, ISession_closeRequestMsg) is False:
            raise TypeError, "%s incorrect request type" % (request.__class__)
        kw = {}
        # no input wsaction
        self.binding.Send(None, None, request, soapaction="", **kw)
        # no output wsaction
        response = self.binding.Receive(ISession_closeResultMsg.typecode)
        return response
...
IVirtualBox_createLegacyMachineRequestMsg = ns0.IVirtualBox_createLegacyMachine_Dec().pyclass

IVirtualBox_createLegacyMachineResultMsg = ns0.IVirtualBox_createLegacyMachineResponse_Dec().pyclass
...
IVirtualBox_getMachineRequestMsg = ns0.IVirtualBox_getMachine_Dec().pyclass

IVirtualBox_getMachineResultMsg = ns0.IVirtualBox_getMachineResponse_Dec().pyclass
...
IVirtualBox_unregisterMachineRequestMsg = ns0.IVirtualBox_unregisterMachine_Dec().pyclass

IVirtualBox_unregisterMachineResultMsg = ns0.IVirtualBox_unregisterMachineResponse_Dec().pyclass
...
IVirtualBox_openHardDiskRequestMsg = ns0.IVirtualBox_openHardDisk_Dec().pyclass

IVirtualBox_openHardDiskResultMsg = ns0.IVirtualBox_openHardDiskResponse_Dec().pyclass

IVirtualBox_getHardDiskRequestMsg = ns0.IVirtualBox_getHardDisk_Dec().pyclass

IVirtualBox_getHardDiskResultMsg = ns0.IVirtualBox_getHardDiskResponse_Dec().pyclass

IVirtualBox_findHardDiskRequestMsg = ns0.IVirtualBox_findHardDisk_Dec().pyclass

IVirtualBox_findHardDiskResultMsg = ns0.IVirtualBox_findHardDiskResponse_Dec().pyclass

IVirtualBox_openDVDImageRequestMsg = ns0.IVirtualBox_openDVDImage_Dec().pyclass

IVirtualBox_openDVDImageResultMsg = ns0.IVirtualBox_openDVDImageResponse_Dec().pyclass

IVirtualBox_getDVDImageRequestMsg = ns0.IVirtualBox_getDVDImage_Dec().pyclass

IVirtualBox_getDVDImageResultMsg = ns0.IVirtualBox_getDVDImageResponse_Dec().pyclass

IVirtualBox_findDVDImageRequestMsg = ns0.IVirtualBox_findDVDImage_Dec().pyclass

IVirtualBox_findDVDImageResultMsg = ns0.IVirtualBox_findDVDImageResponse_Dec().pyclass

IVirtualBox_openFloppyImageRequestMsg = ns0.IVirtualBox_openFloppyImage_Dec().pyclass

IVirtualBox_openFloppyImageResultMsg = ns0.IVirtualBox_openFloppyImageResponse_Dec().pyclass

IVirtualBox_getFloppyImageRequestMsg = ns0.IVirtualBox_getFloppyImage_Dec().pyclass

IVirtualBox_getFloppyImageResultMsg = ns0.IVirtualBox_getFloppyImageResponse_Dec().pyclass

IVirtualBox_findFloppyImageRequestMsg = ns0.IVirtualBox_findFloppyImage_Dec().pyclass

IVirtualBox_findFloppyImageResultMsg = ns0.IVirtualBox_findFloppyImageResponse_Dec().pyclass
...
IVirtualBox_openSessionRequestMsg = ns0.IVirtualBox_openSession_Dec().pyclass

IVirtualBox_openSessionResultMsg = ns0.IVirtualBox_openSessionResponse_Dec().pyclass

IVirtualBox_openRemoteSessionRequestMsg = ns0.IVirtualBox_openRemoteSession_Dec().pyclass

IVirtualBox_openRemoteSessionResultMsg = ns0.IVirtualBox_openRemoteSessionResponse_Dec().pyclass

IVirtualBox_openExistingSessionRequestMsg = ns0.IVirtualBox_openExistingSession_Dec().pyclass

IVirtualBox_openExistingSessionResultMsg = ns0.IVirtualBox_openExistingSessionResponse_Dec().pyclass

IVirtualBox_waitForPropertyChangeRequestMsg = ns0.IVirtualBox_waitForPropertyChange_Dec().pyclass

IVirtualBox_waitForPropertyChangeResultMsg = ns0.IVirtualBox_waitForPropertyChangeResponse_Dec().pyclass
...
IMachine_getVRDPServerRequestMsg = ns0.IMachine_getVRDPServer_Dec().pyclass

IMachine_getVRDPServerResultMsg = ns0.IMachine_getVRDPServerResponse_Dec().pyclass
...
IMachine_getIoBandwidthMaxRequestMsg = ns0.IMachine_getIoBandwidthMax_Dec().pyclass

IMachine_getIoBandwidthMaxResultMsg = ns0.IMachine_getIoBandwidthMaxResponse_Dec().pyclass

IMachine_setIoBandwidthMaxRequestMsg = ns0.IMachine_setIoBandwidthMax_Dec().pyclass

IMachine_setIoBandwidthMaxResultMsg = ns0.IMachine_setIoBandwidthMaxResponse_Dec().pyclass
...
IMachine_deleteSettingsRequestMsg = ns0.IMachine_deleteSettings_Dec().pyclass

IMachine_deleteSettingsResultMsg = ns0.IMachine_deleteSettingsResponse_Dec().pyclass
...
IMachine_getSnapshotRequestMsg = ns0.IMachine_getSnapshot_Dec().pyclass

IMachine_getSnapshotResultMsg = ns0.IMachine_getSnapshotResponse_Dec().pyclass
...
IMachine_setCurrentSnapshotRequestMsg = ns0.IMachine_setCurrentSnapshot_Dec().pyclass

IMachine_setCurrentSnapshotResultMsg = ns0.IMachine_setCurrentSnapshotResponse_Dec().pyclass
...
IConsole_getRemoteDisplayInfoRequestMsg = ns0.IConsole_getRemoteDisplayInfo_Dec().pyclass

IConsole_getRemoteDisplayInfoResultMsg = ns0.IConsole_getRemoteDisplayInfoResponse_Dec().pyclass
...
IConsole_forgetSavedStateRequestMsg = ns0.IConsole_forgetSavedState_Dec().pyclass

IConsole_forgetSavedStateResultMsg = ns0.IConsole_forgetSavedStateResponse_Dec().pyclass
...
ISystemProperties_getMaxVDISizeRequestMsg = ns0.ISystemProperties_getMaxVDISize_Dec().pyclass

ISystemProperties_getMaxVDISizeResultMsg = ns0.ISystemProperties_getMaxVDISizeResponse_Dec().pyclass
...
ISystemProperties_getDefaultHardDiskFolderRequestMsg = ns0.ISystemProperties_getDefaultHardDiskFolder_Dec().pyclass

ISystemProperties_getDefaultHardDiskFolderResultMsg = ns0.ISystemProperties_getDefaultHardDiskFolderResponse_Dec().pyclass

ISystemProperties_setDefaultHardDiskFolderRequestMsg = ns0.ISystemProperties_setDefaultHardDiskFolder_Dec().pyclass

ISystemProperties_setDefaultHardDiskFolderResultMsg = ns0.ISystemProperties_setDefaultHardDiskFolderResponse_Dec().pyclass
...
ISystemProperties_getRemoteDisplayAuthLibraryRequestMsg = ns0.ISystemProperties_getRemoteDisplayAuthLibrary_Dec().pyclass

ISystemProperties_getRemoteDisplayAuthLibraryResultMsg = ns0.ISystemProperties_getRemoteDisplayAuthLibraryResponse_Dec().pyclass

ISystemProperties_setRemoteDisplayAuthLibraryRequestMsg = ns0.ISystemProperties_setRemoteDisplayAuthLibrary_Dec().pyclass

ISystemProperties_setRemoteDisplayAuthLibraryResultMsg = ns0.ISystemProperties_setRemoteDisplayAuthLibraryResponse_Dec().pyclass
...
IGuest_getAdditionsActiveRequestMsg = ns0.IGuest_getAdditionsActive_Dec().pyclass

IGuest_getAdditionsActiveResultMsg = ns0.IGuest_getAdditionsActiveResponse_Dec().pyclass
...
IGuest_getPageFusionEnabledRequestMsg = ns0.IGuest_getPageFusionEnabled_Dec().pyclass

IGuest_getPageFusionEnabledResultMsg = ns0.IGuest_getPageFusionEnabledResponse_Dec().pyclass

IGuest_setPageFusionEnabledRequestMsg = ns0.IGuest_setPageFusionEnabled_Dec().pyclass

IGuest_setPageFusionEnabledResultMsg = ns0.IGuest_setPageFusionEnabledResponse_Dec().pyclass
...
IVRDPServer_getEnabledRequestMsg = ns0.IVRDPServer_getEnabled_Dec().pyclass

IVRDPServer_getEnabledResultMsg = ns0.IVRDPServer_getEnabledResponse_Dec().pyclass

IVRDPServer_setEnabledRequestMsg = ns0.IVRDPServer_setEnabled_Dec().pyclass

IVRDPServer_setEnabledResultMsg = ns0.IVRDPServer_setEnabledResponse_Dec().pyclass

IVRDPServer_getPortsRequestMsg = ns0.IVRDPServer_getPorts_Dec().pyclass

IVRDPServer_getPortsResultMsg = ns0.IVRDPServer_getPortsResponse_Dec().pyclass

IVRDPServer_setPortsRequestMsg = ns0.IVRDPServer_setPorts_Dec().pyclass

IVRDPServer_setPortsResultMsg = ns0.IVRDPServer_setPortsResponse_Dec().pyclass

IVRDPServer_getNetAddressRequestMsg = ns0.IVRDPServer_getNetAddress_Dec().pyclass

IVRDPServer_getNetAddressResultMsg = ns0.IVRDPServer_getNetAddressResponse_Dec().pyclass

IVRDPServer_setNetAddressRequestMsg = ns0.IVRDPServer_setNetAddress_Dec().pyclass

IVRDPServer_setNetAddressResultMsg = ns0.IVRDPServer_setNetAddressResponse_Dec().pyclass

IVRDPServer_getAuthTypeRequestMsg = ns0.IVRDPServer_getAuthType_Dec().pyclass

IVRDPServer_getAuthTypeResultMsg = ns0.IVRDPServer_getAuthTypeResponse_Dec().pyclass

IVRDPServer_setAuthTypeRequestMsg = ns0.IVRDPServer_setAuthType_Dec().pyclass

IVRDPServer_setAuthTypeResultMsg = ns0.IVRDPServer_setAuthTypeResponse_Dec().pyclass

IVRDPServer_getAuthTimeoutRequestMsg = ns0.IVRDPServer_getAuthTimeout_Dec().pyclass

IVRDPServer_getAuthTimeoutResultMsg = ns0.IVRDPServer_getAuthTimeoutResponse_Dec().pyclass

IVRDPServer_setAuthTimeoutRequestMsg = ns0.IVRDPServer_setAuthTimeout_Dec().pyclass

IVRDPServer_setAuthTimeoutResultMsg = ns0.IVRDPServer_setAuthTimeoutResponse_Dec().pyclass

IVRDPServer_getAllowMultiConnectionRequestMsg = ns0.IVRDPServer_getAllowMultiConnection_Dec().pyclass

IVRDPServer_getAllowMultiConnectionResultMsg = ns0.IVRDPServer_getAllowMultiConnectionResponse_Dec().pyclass

IVRDPServer_setAllowMultiConnectionRequestMsg = ns0.IVRDPServer_setAllowMultiConnection_Dec().pyclass

IVRDPServer_setAllowMultiConnectionResultMsg = ns0.IVRDPServer_setAllowMultiConnectionResponse_Dec().pyclass

IVRDPServer_getReuseSingleConnectionRequestMsg = ns0.IVRDPServer_getReuseSingleConnection_Dec().pyclass

IVRDPServer_getReuseSingleConnectionResultMsg = ns0.IVRDPServer_getReuseSingleConnectionResponse_Dec().pyclass

IVRDPServer_setReuseSingleConnectionRequestMsg = ns0.IVRDPServer_setReuseSingleConnection_Dec().pyclass

IVRDPServer_setReuseSingleConnectionResultMsg = ns0.IVRDPServer_setReuseSingleConnectionResponse_Dec().pyclass

IVRDPServer_getVideoChannelRequestMsg = ns0.IVRDPServer_getVideoChannel_Dec().pyclass

IVRDPServer_getVideoChannelResultMsg = ns0.IVRDPServer_getVideoChannelResponse_Dec().pyclass

IVRDPServer_setVideoChannelRequestMsg = ns0.IVRDPServer_setVideoChannel_Dec().pyclass

IVRDPServer_setVideoChannelResultMsg = ns0.IVRDPServer_setVideoChannelResponse_Dec().pyclass

IVRDPServer_getVideoChannelQualityRequestMsg = ns0.IVRDPServer_getVideoChannelQuality_Dec().pyclass

IVRDPServer_getVideoChannelQualityResultMsg = ns0.IVRDPServer_getVideoChannelQualityResponse_Dec().pyclass

IVRDPServer_setVideoChannelQualityRequestMsg = ns0.IVRDPServer_setVideoChannelQuality_Dec().pyclass

IVRDPServer_setVideoChannelQualityResultMsg = ns0.IVRDPServer_setVideoChannelQualityResponse_Dec().pyclass
...
ISession_closeRequestMsg = ns0.ISession_close_Dec().pyclass

ISession_closeResultMsg = ns0.ISession_closeResponse_Dec().pyclass
